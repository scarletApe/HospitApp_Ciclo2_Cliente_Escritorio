...
public class VerPacientesJInternalFrame extends javax.swing.JInternalFrame {
    ...
    public VerPacientesJInternalFrame() {
        ...
        jTextFieldNombre.setDocument(new FixedSizeAlphabeticalDocument(jTextFieldNombre, 30));
        jTextFieldApellido.setDocument(new FixedSizeAlphabeticalDocument(jTextFieldApellido, 30));
...
//                    jLabelErrorMsg.setForeground(Color.red);
                ...
                if(!val.isValidNss(nss)){
                    jLabelErrorMsg.setText("El NSS debe tener 11 dígitos, puede llevar un solo guión.");
                    jLabelErrorMsg.setForeground(Color.red);
                    return;
                }
                
                if(!val.isValidFirstName(firstName)){
                    jLabelErrorMsg.setText("El nombre debe ser de más de 3 caracteres y empezar con una mayúscula.");
                    jLabelErrorMsg.setForeground(Color.red);
                    return;
                }
                
                if(!val.isValidLastName(lastName)){
                    jLabelErrorMsg.setText("El apellido debe ser de más de 3 caracteres.");
                    jLabelErrorMsg.setForeground(Color.red);
                    return;
                }
...
//                }
                ...
                if(!val.isValidEmail(address)){
                    jLabelErrorMsg.setText("El Email debe de tener solamente un @ intermedio.");
                    jLabelErrorMsg.setForeground(Color.red);
                    return;
                }
                
                if(!val.isValidPassword(password)){
                    jLabelErrorMsg.setText("La contraseña debe llevar al menos una mayúscula, un número y debe tener mínimo 8 caracteres.");
                    jLabelErrorMsg.setForeground(Color.red);
                    return;
                }
