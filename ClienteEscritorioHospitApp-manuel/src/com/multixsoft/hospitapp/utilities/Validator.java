...
public class Validator {
    ...
    private final String nssValidation ="^[1-9][\\-\\d]*(\\d+)$";
    ...
    public boolean isValidFirstName(String firstName){
        return firstName.matches(firstNameValidation)&& firstName.length()>3 && firstName.length()<30;
    }

    public boolean isValidLastName(String lastName){
        return lastName.matches(lastNameValidation) && lastName.length()>3 && lastName.length()<30;
    }
