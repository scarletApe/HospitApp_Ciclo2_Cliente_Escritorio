...
//                }
                ...
                if(!val.isValidLastName(lastName)){
                    jLabelError.setText("El apellido debe ser de más de 3 caracteres y no debe contener caracteres especiales.");
                    jLabelError.setForeground(Color.red);
                    return;
                }
...
//                }
                ...
                if(!val.isValidPassword(password)){
                    jLabelError.setText("La contraseña debe combinar mayúsculas, minúsculas y números");
                    if(password.length() < 8)
                        jLabelError.setText("La contraseña debe tener mínimo 8 caracteres.");
                    jLabelError.setForeground(Color.red);
                    return;
                }
