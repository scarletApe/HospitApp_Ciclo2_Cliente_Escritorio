 ...
 */
public class HorariosJFrame extends javax.swing.JFrame {
    ...
    public HorariosJFrame(Doctor d) {
        this();
        doctor = d;
...
//        long id = (long) (Math.random() * 100000);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HorariosJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HorariosJFrame().setVisible(true);
            }
        });
    }
