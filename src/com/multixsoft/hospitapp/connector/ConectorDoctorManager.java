...
public class ConectorDoctorManager {
     ...
     * elimina de la base de datos ya que implica eliminar antes todas sus
     * relaciones y eso afectaria al momento de tratar de generar el historial.
     * Primero cancela todas las citas pendientes para el y despúes vuelve nulo
     * el campo de doctor de todos los pacientes, además vuelve nulo el horario
     * asignado y al final inhabilita al doctor.
     *
     * @param d corresponde al doctor a inhabilitar
     * @return una variable booleana que indica si gue posible o no inhabilitar
     * al doctor en el sistema
     */
    public boolean deleteDoctor(Doctor d) {
        ...
        if (listPatients != null) {
            for (Object p : listPatients) {
                ...
                System.out.println("CDM Patien="+p.toString());
                
                paciente.setDoctorUsername(null);
                ConectorServicio ser = ConectorServicio.getInstance();
                ser.updatePatientSinJOption(paciente);
            }
        }else{
            System.out.println("La lista de pacientes es nulla");
        }
...
//        }
    ...
    /**
     * Este metodo obtiene todos los pacientes de la base de datos que
     * correspondan a un doctor en particular
     *
     * @param d corresponde al medico del que se desean obtener los pacientes
     * @return una lista que contiene todos los pacientes del medico en
     * específico
     */
    private List<Patient> getPatientsFor(Doctor d) {
        ...
        try {
            String urlBusqueda = URL_BASE + "doctormanager/patientsfor?username="
            ...
            if (codigo == HttpURLConnection.HTTP_OK) {
                ...
                for (Object elem : patientsList) {
                    ...
                    patient.setLastName((String) patientJson.get("lastName"));
                ...
                System.err.println("Error response code en getpatientfor="+codigo);
            }
     ...
     * @return una variable booleana que indica si el horario se puedo eliminar
     * o no
     */
    ...
    /**
     * Este metodo se encarga de hacer que un doctor esté inactivo en el
     * hospital
     *
     * @param d representa al doctor que se volverá inactivo
     * @return una variable booleana que indica si se pudo realizar la acción o
     * no
     */
